...
#define HHHL_V2_1R_CHIP_SETTINGS \
{ \
	{ \
		...
		.odtdq = PHY_DDR_MEMIMP_48_OHM,   /* second rank should be zero */ \
		.odtwck =  PHY_DDR_MEMIMP_48_OHM, /* second rank should be zero */ \
		.mempdds = PHY_DDR_MEMIMP_40_OHM, /* second rank should be zero */ \
		.memcaodt = PHY_DDR_MEMIMP_80_OHM, \
		.memcsodt = PHY_DDR_MEMIMPCS_80_OHM, \
		.memdqodt = PHY_DDR_MEMIMP_40_OHM, /* second rank should be zero */ \
		.memodtnt = PHY_DDR_MEMIMP_DISABLE, \
...
const boardinfo_t boardinfo_modalix_hhhl_v2 = {
	.name = "SiMa.ai Modalix HHHL v2 32GB board",
	.id = MODALIX_HHHL_V2,
	.ddr = &ddrc_settings_simaai_dvt16,
	.ubootdtb = "simaai-modalix-hhhl_v2",
	.linuxdtb = "modalix-hhhl_v2.dtb",
};
