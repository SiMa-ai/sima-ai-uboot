...
static ddrc_settings_t ddrc_settings_simaai_charboard = {
	.ddrc_mask = 0xf,
	.type = PHY_DDR_FREQ_800MHz,
	.chip_settings = {
		[0] = {
...
const boardinfo_t boardinfo_simaai_charboard = {
	.name = "SiMa.ai Characterization board",
	.id = DAVINCI_CHAR_BOARD,
	.ddr = &ddrc_settings_simaai_charboard,
